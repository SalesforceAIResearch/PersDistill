*This is a suggested `CONTRIBUTING.md` file template for use by open sourced Salesforce projects. The main goal of this file is to make clear the intents and expectations that end-users may have regarding this project and how/if to engage with it. Adjust as needed (especially look for `PersDistill` which refers to the org and repo name of your project) and remove this paragraph before committing to your repo.*

# Contributing Guide For PersDistill

This page lists the operational governance model of this project, as well as the recommendations and requirements for how to best contribute to PersDistill. We strive to obey these as best as possible. As always, thanks for contributing – we hope these guidelines make it easier and shed some light on our approach and processes.
...
-  If you find a bug, please search for it in the [Issues](https://github.com/PersDistill/issues), and if it isn't already tracked,
   [create a new issue](https://github.com/PersDistill/issues/new). Fill out the "Bug Report" section of the issue template. Even if an Issue is closed, feel free to comment and add details, it will still
   be reviewed.
...
### New Features
-  If you'd like to add new functionality to this project, describe the problem you want to solve in a [new Issue](https://github.com/PersDistill/issues/new).
...
-  If you'd like to improve the tests, you want to make the documentation clearer, you have an
  ...
  -  If not, [open an Issue](https://github.com/PersDistill/issues/new) to discuss the idea first.
